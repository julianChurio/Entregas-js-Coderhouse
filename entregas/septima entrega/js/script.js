...
let sumarDS = () => {
  nombreJuego = juegosSouls[0].nombre;
...
let sumarDS1 = () => {
  nombreJuego = juegosSouls[1].nombre;
...
let sumarDS2 = () => {
  nombreJuego = juegosSouls[2].nombre;
...
let sumarDS3 = () => {
  nombreJuego = juegosSouls[3].nombre;
...
let sumarBB = () => {
  nombreJuego = juegosSouls[4].nombre;
